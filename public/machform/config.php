...
/** MySQL settings **/
define('MF_DB_NAME', 'mach_cam'); //The name of your database. Note that this database must exist before running installer.php
define('MF_DB_USER', 'root'); //Your database username
define('MF_DB_PASSWORD', 'macprorocketship'); //Your database users password
